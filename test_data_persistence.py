#!/usr/bin/env python3
"""
Test script to verify data persistence in Neon PostgreSQL
"""
import os
import uuid
...
def test_data_persistence():
    """Test that data is actually persisted in Neon PostgreSQL"""
    print("Testing data persistence in Neon PostgreSQL...")
    ...
    try:
        ...
        with Session(engine) as session:
            ...
            if user_from_db and user_from_db.email == "testuser@example.com":
            ...
            if len(user_tasks) == 1 and user_tasks[0].id == test_task.id:
