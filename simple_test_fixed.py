#!/usr/bin/env python3
"""
Simple test to see what attributes are available - fixed import order
"""
import os
from dotenv import load_dotenv
from sqlalchemy import create_engine, select
from sqlmodel import Session
from backend.src.models.task_model import Task  # Import Task first to resolve circular dependency
